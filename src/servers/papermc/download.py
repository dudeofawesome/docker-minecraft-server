...
download_url = f"https://papermc.io/api/v2/projects/paper/versions/{minecraft_version}/builds/386/downloads/{download_info['name']}"

print(f"{minecraft_version} {builds[0]['build']} {download_url} {download_info['sha256']}")
